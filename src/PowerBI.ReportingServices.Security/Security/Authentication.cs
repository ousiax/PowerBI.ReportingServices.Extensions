...
namespace PowerBI.ReportingServices.Security.Cas
{
    public sealed class Authentication : IAuthenticationExtension2
    {
        /// <summary>
        ...
        {
            return ServiceUtility.Provider.GetService<IUserService>().Exists(principalName);
        }
    }
}
